        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            ...
            <motion.section
              ...
              className="bg-white dark:bg-[#0f1f35] p-8 rounded-xl shadow-lg"
            >
              ...
              <form className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full bg-gradient-to-r from-blue-600 to-orange-500 text-white py-3 px-6 
                           rounded-lg hover:from-blue-700 hover:to-orange-600 
                           transition-colors flex items-center justify-center gap-2 group"
                >
                  <span>Envoyer</span>
                  <span className="transform group-hover:translate-x-1 transition-transform">{contactIcons.send}</span>
                </button>
              </form>
            </motion.section>
          ...
          <div className="space-y-8">
              ...
              <div className="space-y-6">
                <a
                  ...
                  className="flex items-center gap-4 text-gray-600 dark:text-gray-300 
                            ...
                            p-4 rounded-lg hover:bg-orange-50 dark:hover:bg-orange-950 group"
                >
                  <span className="text-orange-500 dark:text-orange-400">{contactIcons.phone}</span>
                  <div>
                    <p
                      className="font-medium group-hover:text-orange-500 
                                dark:group-hover:text-orange-400"
                    >
                      Téléphone
                    </p>
                    <p>+224 625 21 21 15</p>
                  </div>
                </a>

                <a
                  href="mailto:mory.koulibaly@nimbasolution.com"
                  className="flex items-center gap-4 text-gray-600 dark:text-gray-300 
                            hover:text-orange-500 dark:hover:text-orange-400 transition-colors 
                            p-4 rounded-lg hover:bg-orange-50 dark:hover:bg-orange-950 group"
                >
                  <span className="text-orange-500 dark:text-orange-400">{contactIcons.email}</span>
                  <div>
                    <p
                      className="font-medium group-hover:text-orange-500 
                                dark:group-hover:text-orange-400"
                    ...
                    <p>mory.koulibaly@nimbasolution.com</p>
                  </div>
                </a>
                ...
                <div
                  className="flex items-center gap-4 text-gray-600 dark:text-gray-300 
                              p-4 rounded-lg"
                >
                  <span className="text-orange-500 dark:text-orange-400">{contactIcons.location}</span>
                  <div>
                    <p className="font-medium dark:text-white">Adresse</p>
                    <p>Conakry, Guinée</p>
                    <p>Foulamadina, Commune de Sonfonia</p>
                  </div>
                </div>

                <a
                  href="https://wa.me/224625212115"
                  target="_blank"
                  ...
                  className="flex items-center gap-4 text-gray-600 dark:text-gray-300 
                            ...
                            p-4 rounded-lg hover:bg-orange-50 dark:hover:bg-orange-950 group"
                >
                  <span className="text-orange-500 dark:text-orange-400">{contactIcons.whatsapp}</span>
                  <div>
                    <p
                      className="font-medium group-hover:text-orange-500 
                                dark:group-hover:text-orange-400"
            ...
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.4 }}
              className="bg-white dark:bg-[#0f1f35] p-4 rounded-xl shadow-lg overflow-hidden h-[400px]"
            >
              <iframe
