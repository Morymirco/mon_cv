...
const icons = {
  education: (
    <svg className="w-6 h-6 text-orange-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
  ...
  dot: (
    <svg className="w-2 h-2 text-orange-500" fill="currentColor" viewBox="0 0 8 8" aria-hidden="true">
...
export default function AProposClient() {
  ...
  return (
    <main className="pt-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto pb-16">
      <motion.div initial="initial" animate="animate" variants={stagger} className="space-y-12">
        {/* En-tête */}
        <motion.header variants={fadeIn} className="text-center">
          ...
          <div className="max-w-3xl mx-auto">
            <p className="text-xl text-gray-600 leading-relaxed">
              Je suis Mory Koulibaly, passionné par le développement web et mobile, avec une expertise dans la création
              de sites e-commerce, d'applications SaaS, et de solutions personnalisées. Je combine créativité,
              efficacité et maîtrise technique pour répondre aux besoins de mes clients.
            </p>
          </div>
        </motion.header>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <motion.section
            variants={fadeIn}
            className="bg-white dark:bg-card p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow"
            aria-labelledby="formation-heading"
          >
            <h2 id="formation-heading" className="text-2xl font-semibold mb-6 flex items-center gap-3">
              {icons.education}
              Formation
            </h2>
          ...
          >
            <h2 id="experience-heading" className="text-2xl font-semibold mb-6 flex items-center gap-3">
              {icons.experience}
              Expérience
            </h2>
          ...
          >
            <h2 id="valeurs-heading" className="text-2xl font-semibold mb-6 flex items-center gap-3">
              {icons.values}
              Mes Valeurs
            </h2>
            <div className="space-y-4">
          ...
          >
            <h2 id="objectifs-heading" className="text-2xl font-semibold mb-6 flex items-center gap-3">
              {icons.objectives}
              Objectifs
            </h2>
            <div className="space-y-4">
              <p className="text-gray-600">
                Contribuer au développement numérique en Guinée en créant des solutions innovantes et accessibles. Mon
