...
export default function NotFound() {
  return (
    <main className="min-h-screen flex items-center justify-center px-4 dark:bg-background">
      <div className="text-center space-y-8">
        ...
        >
          <h1
            className="text-9xl font-bold bg-gradient-to-r from-blue-600 to-blue-800 
          ...
          >
            <svg className="w-32 h-32 text-blue-600/20" fill="currentColor" viewBox="0 0 24 24">
