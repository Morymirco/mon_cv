    ...
    <main className="pt-24 px-4 sm:px-6 lg:px-8 pb-16 dark:bg-[#091525]">
      <motion.article initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="max-w-7xl mx-auto">
        ...
        >
          ...
          <h1 className="text-4xl font-bold mt-6 mb-4 dark:text-white">{post.title}</h1>
        ...
        >
          ...
          <div className="bg-white dark:bg-[#101828] p-6 rounded-xl shadow-lg mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    type="text"
                    id="name"
                    className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 dark:bg-[#101828] dark:text-white rounded-lg focus:ring-2 
          ...
          <div className="space-y-6">
            {[
              ...
              },
              {
                ...
                date: "Il y a 3 jours",
                content:
                  "Merci pour ces explications détaillées. J'ai particulièrement apprécié la partie sur l'optimisation des performances.",
